...
local function run_graphics_asset_tests()
    ...
    test("graphics.pixelmap_flood_fill", "changes bounded region and no-ops on OOB and same-color", function()
    ...
    test("graphics.blit_*", "geometry op smoke and fully clipped no-ops", function()
...
local function run_graphics_draw_tests()
    ...
    test("graphics.clear/draw_rect/debug_line/debug_rect/debug_text", "core draw calls do not throw and omitted colors work", function()
        graphics.clear()
    ...
    test("graphics.draw_image/draw_image_region", "image draw calls work and nil misuse is loud", function()
